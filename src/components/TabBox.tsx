...
export default function TabBox() {
  ...
  return (
    <Stack direction="row" sx={{ width: '100%', marginBottom: 5 }} className='Info-Section'>
      ...
      A <b>Delaunay Triangulation</b> triangulates a set of points such that no circumcircle of any triangle - that is, the circle containing the triangle’s three vertices on its circumference - contains any other point in the set. The left plot above will create a Delaunay Triangulation of a set of points - click to place a point on the canvas, and the triangulation will automatically be created.
      <br/><br/>
      One side effect of the circumcircle rule - known as the “Delaunay condition” - is that a Delaunay triangulation generally produces “nice” triangles. Mathematically, the minimum angle of the triangulation is maximized, as is the 2nd minimum, 3rd minimum, and so on. Experiment by creating a triangulation and moving a point around. Notice how when a point moves around the center of the triangulation, it quickly forms and deletes edges, keeping its pattern of “nice” triangles rather than stretching and modifying the previous ones. 
      <br/><br/>
